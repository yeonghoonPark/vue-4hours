...
const routes = [
  ...
  },
  {
    ...
    component: () =>
      import(
        /* webpackChunkName: "event", webpackPrefetch: ture */ '../views/2_event/EventChangeView.vue'
      )
  },
  {
    path: '/event/key',
    ...
    component: () =>
      import(
        /* webpackChunkName: "event", webpackPrefetch: ture */ '../views/2_event/EventKeyView.vue'
      )
  }
]
